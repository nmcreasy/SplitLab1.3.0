...
handles.period = uicontrol('Units','pixel', 'Style','slider','Parent',HP,'Callback', @periodCallback,...
    'Position',[10 60 175 15], 'Value', 8,'Min',0,'Max',20, 'SliderStep', [1/20 .1] );
...
set(handles.theoLines(:), 'LineStyle', str{val})
