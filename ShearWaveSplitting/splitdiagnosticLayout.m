...
axRC(1) = axes('Parent',panel1,'units','normalized', 'position',[.03 .12 .25  .8], 'Box','on', 'Fontsize',fontsize);
axRC(2) = axes('Parent',panel1,'units','normalized', 'position',[.31 .12 .25  .8], 'Box','on', 'Fontsize',fontsize);
axRC(3) = axes('Parent',panel1,'units','normalized', 'position',[.53 .12 .25  .8], 'Box','on', 'Fontsize',fontsize);
axRC(4) = axes('Parent',panel1,'units','normalized', 'position',[.77 .12 .22  .8], 'Box','on', 'Fontsize',fontsize,'Layer','top');

axSC(1) = axes('Parent',panel2,'units','normalized', 'position',[.03 .12 .25  .8], 'Box','on', 'Fontsize',fontsize);
axSC(2) = axes('Parent',panel2,'units','normalized', 'position',[.31 .12 .25  .8], 'Box','on', 'Fontsize',fontsize);
axSC(3) = axes('Parent',panel2,'units','normalized', 'position',[.53 .12 .25  .8], 'Box','on', 'Fontsize',fontsize);
axSC(4) = axes('Parent',panel2,'units','normalized', 'position',[.77 .12 .22  .8], 'Box','on', 'Fontsize',fontsize,'Layer','top');
