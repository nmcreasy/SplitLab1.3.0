...
thiseq.tmpresult.Ematrix = Ematrix;
...
[C, h] = contourf(ts,ps,-Cmatrix,-[LevelRC LevelRC],'b','Fill','on','LineWidth',3);
...
[C, h] = contourf(ts,ps,-Ematrix,-[Level Level],'b','Fill','off','LineWidth',3);
...
hold on
plot(t2, Q/max(abs(Q)), 'b--', t2, T/max(abs(Q)), 'r-','LineWidth',1)
...
if license('checkout', 'MAP_Toolbox')==1
