...
%read in
try
    e = sl_rsac(fullfile(config.datadir, thiseq.seisfiles{1}));
    n = sl_rsac(fullfile(config.datadir, thiseq.seisfiles{2}));
    v = sl_rsac(fullfile(config.datadir, thiseq.seisfiles{3}));
catch
    e = sl_rsacsun(fullfile(config.datadir, thiseq.seisfiles{1}));
    n = sl_rsacsun(fullfile(config.datadir, thiseq.seisfiles{2}));
    v = sl_rsacsun(fullfile(config.datadir, thiseq.seisfiles{3}));
end
comps.Kname.E=sl_lh(e,'KCMPNM');
comps.Kname.N=sl_lh(n,'KCMPNM');
comps.Kname.Z=sl_lh(v,'KCMPNM');
