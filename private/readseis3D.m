...
try
    e = sl_rsac(efile);set(s,'String', '  Status:   Reading seismograms ... East');drawnow
    n = sl_rsac(nfile);set(s,'String', '  Status:   Reading seismograms ... East North');drawnow
    v = sl_rsac(zfile);set(s,'String', '  Status:   Reading seismograms ... East North Vertical');drawnow
catch
    e = sl_rsacsun(efile);set(s,'String', '  Status:   Reading seismograms ... East');drawnow
    n = sl_rsacsun(nfile);set(s,'String', '  Status:   Reading seismograms ... East North');drawnow
    v = sl_rsacsun(zfile);set(s,'String', '  Status:   Reading seismograms ... East North Vertical');drawnow
end

%% get SAC header markers:
[A(1), F(1), O(1)] = sl_lh(e, 'A', 'F', 'O');
[A(2), F(2), O(2)] = sl_lh(n, 'A', 'F', 'O');
[A(3), F(3), O(3)] = sl_lh(v, 'A', 'F', 'O');
