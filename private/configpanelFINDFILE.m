...
%% File format:
str = {'RDSEED' 'SEISAN' 'mseed2sac1' 'mseed2sac2' 'YYYY.JJJ.hh.mm.ss.stn.sac.e' 'YYYY.MM.DD-hh.mm.ss.stn.sac.e' '*.e; *.n; *.z' 'stn.YYMMDD.hhmmss.e' 'YYYY_MM_DD_hhmm_stnn.sac.e'};
val = strmatch(config.FileNameConvention, str);
%val = strncmp(config.FileNameConvention, str);
h.find(3) = uicontrol('Parent',h.panel(7),'Units','pixel',...
    'Style','popupmenu',...
    'BackgroundColor','w',...
    ...
    'Value', 1,...
    'String', str,...
    'tooltip', 'This also sets the file name convention in the Fetch panel!',...
    'Callback',...
