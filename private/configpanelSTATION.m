...
uicontrol('Parent',h.panel(1),'Units','pixel',...
    ...
    'Tooltip','http://orfeus-eu.org/webdc3/',...
    'Callback','web http://orfeus-eu.org/webdc3/ -browser');
uicontrol('Parent',h.panel(1),'Units','pixel',...
    'Style','Pushbutton',...
    'Position',[pos(3)-160 y-67 120 25],...
    'String', 'NEIC station book',...
    'Tooltip','https://earthquake.usgs.gov/earthquakes/search/',...
    'Callback','web https://earthquake.usgs.gov/earthquakes/search/ -browser');
...
h.station(2) = uicontrol('Parent',h.panel(1),'Units','pixel',...
    ...
    'String', config.netw,...
    'FontName','FixedWidth',...
    'ToolTipString','Use ?? or * to wildcard in Fetch',...
...
h.station(6) = uicontrol('Parent',h.panel(1),'Units','pixel',...
    ...
    'String', config.slong,...
    'ToolTipString','Longitude',...
    'FontName','FixedWidth',...
    'Callback','config.slong=str2num(get(gcbo,''String''));');

% Button to set the coordinates in the edit table
h.button = uicontrol('Parent',h.panel(1),'Units','pixel',...
    'Style','Pushbutton',...
    'Position',[pos(3)-160 y-139 120 25],...
    'String', 'Fetch Coordinates',...
    'Tooltip','Calls irisFetch.Stations to find coordinates',...
    'Callback','SL_fetchStationCoordinates');
...
uicontrol('Parent',h.panel(1),'Units','pixel',...
    'Style','Text','FontAngle','Italic',...,
    'Position',[20 10 250 25],...
    'String','Fetching data will return data rotated into E-N-Z based on server metadata.');
